const schema = {
  ...
  whatsapp_connections: ['id', 'company_id', 'name', 'phone_number', 'status', 'qr_code', 'connected_at', 'last_heartbeat_at', 'messages_sent', 'total_failures', 'daily_limit', 'hourly_limit', 'delay_min_ms', 'delay_max_ms', 'session_path', 'created_at', 'updated_at'],
  ...
  contacts: ['id', 'company_id', 'contact_list_id', 'name', 'phone', 'raw_phone', 'tags', 'custom_fields', 'origin', 'status', 'validation_error', 'created_at', 'updated_at'],
