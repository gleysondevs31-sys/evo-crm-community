...
.PHONY: help setup start stop restart logs clean build status render-preview vendor-submodules \
...
vendor-submodules: ## Convert initialized submodules into normal vendored directories
